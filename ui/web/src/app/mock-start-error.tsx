...
export function MockStartError() {
  return (
    <div className="flex min-h-svh flex-col">
      <ComplianceNotices />
      <PageMain className="mx-auto flex max-w-2xl flex-col gap-3 p-6">
        <h1 className="text-2xl font-semibold">
          The mock backend didn't start
        </h1>
        <p role="alert">
        ...
        <p>
          Open the dev server URL in Chrome, Edge or Firefox with service
          workers allowed, or run the dev server with VITE_API_MODE=live against
          a real backend.
        </p>
      </PageMain>
    </div>
